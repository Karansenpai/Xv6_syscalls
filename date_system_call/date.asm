   ...
   e:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(gettime(&r))
  14:	50                   	push   %eax
  15:	e8 41 03 00 00       	call   35b <gettime>
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 dc 07 00 00 	movzbl 0x7dc(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 84 07 00 00 	jmp    *0x784(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 7d 07 00 00       	mov    $0x77d,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d 84 0a 00 00    	mov    0xa84,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 84 0a 00 00    	mov    0xa84,%edx
 ...
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf 88 0a 00 00       	mov    $0xa88,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 732:	00 00 00 
    if(p->s.size >= nunits){
