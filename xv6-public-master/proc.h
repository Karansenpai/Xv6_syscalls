...
struct proc {
  ...
  int timeslice; // The number of time slices used
  int max_timeslice; // The maximum time slice allowed
  int is_running; // A flag to indicate if the process is currently running
