...
int main(int argc, char *argv[]) {
  ...
  20:	74 6a                	je     8c <main+0x8c>
        if (a == 0) {
  22:	85 c0                	test   %eax,%eax
  24:	74 3e                	je     64 <main+0x64>
  ...
  30:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  37:	89 c6                	mov    %eax,%esi
  39:	e8 72 06 00 00       	call   6b0 <malloc>
  ...
  42:	53                   	push   %ebx
  43:	56                   	push   %esi
  44:	e8 b9 02 00 00       	call   302 <waitx>
  ...
  5c:	83 c4 20             	add    $0x20,%esp
    ...
    exit();
  5f:	e8 8e 02 00 00       	call   2f2 <exit>
            if(exec(argv[1], argv + 1)<0){
  64:	8d 46 04             	lea    0x4(%esi),%eax
  67:	53                   	push   %ebx
  68:	53                   	push   %ebx
  69:	50                   	push   %eax
  6a:	ff 76 04             	pushl  0x4(%esi)
  6d:	e8 c8 02 00 00       	call   33a <exec>
  72:	83 c4 10             	add    $0x10,%esp
  75:	85 c0                	test   %eax,%eax
  77:	79 e6                	jns    5f <main+0x5f>
                printf(1,"Error in fork\n");
  79:	51                   	push   %ecx
  7a:	51                   	push   %ecx
  7b:	68 a8 07 00 00       	push   $0x7a8
  80:	6a 01                	push   $0x1
  82:	e8 c9 03 00 00       	call   450 <printf>
                exit();
  87:	e8 66 02 00 00       	call   2f2 <exit>

    }
    else{
        if (a == 0) {
  8c:	85 c0                	test   %eax,%eax
  8e:	74 cf                	je     5f <main+0x5f>
  90:	eb 94                	jmp    26 <main+0x26>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb e8 07 00 00       	mov    $0x7e8,%ebx
        while(*s != 0){
