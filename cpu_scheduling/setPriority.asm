  ...
  13:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  4e:	56                   	push   %esi
  4f:	50                   	push   %eax
  50:	e8 3d 03 00 00       	call   392 <set_priority>
  55:	83 c4 10             	add    $0x10,%esp
  58:	83 c0 01             	add    $0x1,%eax
  5b:	74 18                	je     75 <main+0x75>
        printf(1,"Error in set_priority\n");

    }
    exit();
  5d:	e8 80 02 00 00       	call   2e2 <exit>
        printf(2, "Invalid priority given. Try again\n");
  62:	51                   	push   %ecx
  63:	51                   	push   %ecx
  64:	68 cc 07 00 00       	push   $0x7cc
  69:	6a 02                	push   $0x2
  ...
  75:	50                   	push   %eax
  76:	50                   	push   %eax
  77:	68 b4 07 00 00       	push   $0x7b4
  7c:	6a 01                	push   $0x1
  7e:	e8 bd 03 00 00       	call   440 <printf>
  83:	83 c4 10             	add    $0x10,%esp
  86:	eb d5                	jmp    5d <main+0x5d>
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb f0 07 00 00       	mov    $0x7f0,%ebx
        while(*s != 0){
