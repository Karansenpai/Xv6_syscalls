 ...
 33c:	89 d1                	mov    %edx,%ecx
{
 ...
 369:	0f b6 92 90 07 00 00 	movzbl 0x790(%edx),%edx
 ...
 3e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 459:	ff 24 85 38 07 00 00 	jmp    *0x738(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 567:	90                   	nop
          s = "(null)";
 568:	ba 30 07 00 00       	mov    $0x730,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 581:	a1 38 0a 00 00       	mov    0xa38,%eax
{
 ...
 5c1:	5b                   	pop    %ebx
  freep = p;
 5c2:	89 15 38 0a 00 00    	mov    %edx,0xa38
}
 5c8:	5e                   	pop    %esi
 5c9:	5f                   	pop    %edi
 5ca:	5d                   	pop    %ebp
 ...
 5f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5fc:	89 15 38 0a 00 00    	mov    %edx,0xa38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 3d 38 0a 00 00    	mov    0xa38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65f:	73 4f                	jae    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 661:	8b 3d 38 0a 00 00    	mov    0xa38,%edi
 ...
 68a:	e8 f1 fe ff ff       	call   580 <free>
  return freep;
 68f:	8b 15 38 0a 00 00    	mov    0xa38,%edx
 ...
 6bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 38 0a 00 00    	mov    %edx,0xa38
}
 ...
 6cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6d0:	c7 05 38 0a 00 00 3c 	movl   $0xa3c,0xa38
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	bf 3c 0a 00 00       	mov    $0xa3c,%edi
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 3c 0a 00 00 3c 	movl   $0xa3c,0xa3c
 6e6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6eb:	c7 05 40 0a 00 00 00 	movl   $0x0,0xa40
 6f2:	00 00 00 
    if(p->s.size >= nunits){
