...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 d7 7b 10 80 	movl   $0x80107bd7,(%esp)
...
80104a6f:	8b 70 1c             	mov    0x1c(%eax),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a72:	8d 46 ff             	lea    -0x1(%esi),%eax
80104a75:	83 f8 15             	cmp    $0x15,%eax
80104a78:	77 3e                	ja     80104ab8 <syscall+0x58>
80104a7a:	8b 04 b5 40 79 10 80 	mov    -0x7fef86c0(,%esi,4),%eax
80104a81:	85 c0                	test   %eax,%eax
80104a83:	74 33                	je     80104ab8 <syscall+0x58>
    //cprintf("%s -> %d \n",syscallnames[num],num);
    curproc->tf->eax = syscalls[num]();
80104a85:	ff d0                	call   *%eax
80104a87:	8b 53 18             	mov    0x18(%ebx),%edx
    cprintf("%s -> %d\n", syscall_names[num],curproc->tf->eax);
80104a8a:	83 ec 04             	sub    $0x4,%esp
    curproc->tf->eax = syscalls[num]();
80104a8d:	89 42 1c             	mov    %eax,0x1c(%edx)
    cprintf("%s -> %d\n", syscall_names[num],curproc->tf->eax);
80104a90:	8b 43 18             	mov    0x18(%ebx),%eax
80104a93:	ff 70 1c             	push   0x1c(%eax)
80104a96:	ff 34 b5 e0 78 10 80 	push   -0x7fef8720(,%esi,4)
80104a9d:	68 5d 78 10 80       	push   $0x8010785d
80104aa2:	e8 f9 bb ff ff       	call   801006a0 <cprintf>
...
80104ac0:	68 67 78 10 80       	push   $0x80107867
80104ac5:	e8 d6 bb ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
...
80104c14:	68 b8 79 10 80       	push   $0x801079b8
...
80104c2c:	68 b7 79 10 80       	push   $0x801079b7
...
80104c41:	68 ab 79 10 80       	push   $0x801079ab
...
80104c5f:	68 ba 79 10 80       	push   $0x801079ba
80104c64:	e8 17 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c69:	83 ec 0c             	sub    $0xc,%esp
80104c6c:	68 9c 79 10 80       	push   $0x8010799c
...
8010506d:	58                   	pop    %eax
8010506e:	5a                   	pop    %edx
8010506f:	68 b8 79 10 80       	push   $0x801079b8
...
80105088:	68 b7 79 10 80       	push   $0x801079b7
...
80105850:	b8 b7 07 00 00       	mov    $0x7b7,%eax
80105855:	c3                   	ret    
...
801058ce:	00 00 ef 
  initlock(&tickslock, "time");
801058d1:	68 b0 78 10 80       	push   $0x801078b0
...
80105954:	ff 24 85 a0 7a 10 80 	jmp    *-0x7fef8560(,%eax,4)
...
80105a35:	68 5c 7a 10 80       	push   $0x80107a5c
...
80105a87:	68 04 7a 10 80       	push   $0x80107a04
...
80105ba3:	68 28 7a 10 80       	push   $0x80107a28
80105ba8:	e8 f3 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105bad:	83 c4 14             	add    $0x14,%esp
80105bb0:	68 fd 79 10 80       	push   $0x801079fd
...
80105c5c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c5f:	bf 20 7b 10 80       	mov    $0x80107b20,%edi
...
8010694d:	68 28 7b 10 80       	push   $0x80107b28
...
80106b7b:	68 6d 7b 10 80       	push   $0x80107b6d
...
80106be0:	68 87 7b 10 80       	push   $0x80107b87
...
80106c68:	68 28 7c 10 80       	push   $0x80107c28
...
80106d09:	68 a5 7b 10 80       	push   $0x80107ba5
...
80106d6b:	68 bd 7b 10 80       	push   $0x80107bbd
...
80106e4c:	68 d9 7b 10 80       	push   $0x80107bd9
...
80106f1c:	68 ea 7b 10 80       	push   $0x80107bea
...
80106f92:	68 f4 7b 10 80       	push   $0x80107bf4
...
80107067:	68 0e 7c 10 80       	push   $0x80107c0e
